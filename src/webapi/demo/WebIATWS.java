...
public class WebIATWS extends WebSocketListener {
    ...
    private static final String apiKey = "6b09fc3284f2788d68679a8e6c85b6eb"; //在控制台-我的应用-语音听写（流式版）获取
    private static final String apiSecret = "dc4b075906e8c163ca0416006d296b36"; //在控制台-我的应用-语音听写（流式版）获取
    private static final String appid = "5f27b6a9"; //在控制台-我的应用获取
    private static final String file = "resource\\iat\\ceshi.pcm"; // 中文
    ...
    public void onOpen(WebSocket webSocket, Response response) {
        ...
        new Thread(()->{
            //连接成功，开始发送数据
            int frameSize = 5900; //每一帧音频的大小,建议每 40ms 发送 122B
            int intervel = 40;
            int status = 0;  // 音频的状态
